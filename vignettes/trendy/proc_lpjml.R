...
nc <- nc_open("~/../../data_2/scratch/ttrinidad/data/trendy/raw/LPJmL_S3_gpp.nc")
...
lpjml_gpp_annual_global <- gpp_annual_global*1e-12 #in Pg*C

# IAV of global annual GPP
lpjml_gpp_iav <- sd(lpjml_gpp_annual_global)
...
nc <- nc_open("~/../../data_2/scratch/ttrinidad/data/trendy/raw/LPJmL_S3_nbp.nc")
...
lpjml_nbp_annual_global <- nbp_annual_global*1e-12 #in Pg*C


# IAV of global annual NBP
lpjml_nbp_iav <- sd(lpjml_nbp_annual_global)

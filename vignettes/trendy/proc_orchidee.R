...
nc <- nc_open("~/../../data_2/scratch/ttrinidad/data/trendy/raw/ORCHIDEE_S3_gpp.nc")
...
orchidee_gpp_annual_global <- gpp_annual_global*1e-12 #in Pg*C

# IAV of global annual GPP
orchidee_gpp_iav <- sd(orchidee_gpp_annual_global)
...
nc <- nc_open("~/../../data_2/scratch/ttrinidad/data/trendy/raw/ORCHIDEE_S3_nbp.nc")
...
orchidee_nbp_annual_global <- nbp_annual_global*1e-12 #in Pg*C


# IAV of global annual NBP
orchidee_nbp_iav <- sd(orchidee_nbp_annual_global)

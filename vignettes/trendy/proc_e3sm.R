...
nc <- nc_open("~/../../data_2/scratch/ttrinidad/data/trendy/raw/E3SM_S3_gpp.nc")
...
gpp <- array(gpp, dim = c(288, 192, 12, 323))
...
pseudo_raster <- raster::raster(nrows = 192, ncols = 288, xmn = -180, xmx = 178.75, ymn = -90, ymx = 90)
...
e3sm_gpp_annual_global <- gpp_annual_global*1e-12 #in Pg*C

# IAV of global annual GPP
e3sm_gpp_iav <- sd(e3sm_gpp_annual_global)
...
nc <- nc_open("~/../../data_2/scratch/ttrinidad/data/trendy/raw/E3SM_S3_nbp.nc")
...
e3sm_nbp_annual_global <- nbp_annual_global*1e-12 #in Pg*C


# IAV of global annual NBP
e3sm_nbp_iav <- sd(e3sm_nbp_annual_global)

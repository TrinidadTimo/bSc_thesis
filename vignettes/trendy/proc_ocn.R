...
nc <- nc_open("~/../../data_2/scratch/ttrinidad/data/trendy/raw/OCN_S3_gpp.nc")
...
ocn_gpp_annual_global <- gpp_annual_global*1e-12 #in Pg*C

# IAV of global annual GPP
ocn_gpp_iav <- sd(ocn_gpp_annual_global)
...
nc <- nc_open("~/../../data_2/scratch/ttrinidad/data/trendy/raw/OCN_S3_nbp.nc")
...
ocn_nbp_annual_global <- nbp_annual_global*1e-12 #in Pg*C


# IAV of global annual NBP
ocn_nbp_iav <- sd(ocn_nbp_annual_global)

...
nc <- nc_open("~/../../data_2/scratch/ttrinidad/data/trendy/raw/LPJwsl_S3_gpp.nc")
...
lpjwsl_gpp_annual_global <- gpp_annual_global*1e-12 #in Pg*C

# IAV of global annual GPP
lpjwsl_gpp_iav <- sd(lpjwsl_gpp_annual_global)
...
nc <- nc_open("~/../../data_2/scratch/ttrinidad/data/trendy/raw/LPJwsl_S3_nbp.nc")
...
lpjwsl_nbp_annual_global <- nbp_annual_global*1e-12 #in Pg*C


# IAV of global annual NBP
lpjwsl_nbp_iav <- sd(lpjwsl_nbp_annual_global)
